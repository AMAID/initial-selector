...
module.exports=[
  {"letter":"A","content":["Ajax","Async","Angular"]},
  {"letter":"B","content":["Browser","Body","Backbone","Bootstrap","Boolean"]},
  {"letter":"C","content":["CSS","Cookie"]},
  {"letter":"D","content":["Document","DOM","Div","D3","Dojo"]},
  {"letter":"E","content":["Extjs","Element","ECMA"]},
  {"letter":"F","content":["F2E","Float","Font","Frame","Firefox","Form","FuckIE6"]},
  {"letter":"G","content":["Get","Grunt","Gulp"]},
  {"letter":"H","content":["HTML","Head","Horizontal","Hybird"]},
  {"letter":"I","content":["Iframe","Iscroll"]},
  {"letter":"J","content":["JavaScript","Jquery","Json"]},
  {"letter":"K","content":["Knockout","Kissy","Karma"]},
  {"letter":"L","content":["LESS","LocalStorage","Livereload","Lazyload"]},
  {"letter":"M","content":["Module","Modernizr","Model"]},
  {"letter":"N","content":["Node","Navigator"]},
  {"letter":"O","content":["Object"]},
  {"letter":"P","content":["Post","Polymer","Placeholder","Push","Polyfill","Promise"]},
  {"letter":"Q","content":["QuerySelector"]},
  {"letter":"R","content":["Request","React","Require"]},
  {"letter":"S","content":["Stylus","SASS","Section","SEO"]},
  {"letter":"T","content":["TodoMVC","Transform","Then","TinyMCE"]},
  {"letter":"U","content":["Underscroe","Uglify","UI"]},
  {"letter":"V","content":["Vanilla","View","Vue","Video"]},
  {"letter":"W","content":["W3C","Web","Webpack"]},
  {"letter":"X","content":["XML","XSS","XHR"]},
  {"letter":"Y","content":["Yeoman","YUI","Yield"]},
  {"letter":"Z","content":["Zepto","Zoom"]}
]
},{}],66:[function(require,module,exports){
require("./is-vue.js")
require("./rightbar.js")
},{"./is-vue.js":67,"./rightbar.js":68}],67:[function(require,module,exports){
var Vue=require('vue')
...
var $ = zepto.$
var myScroll = new IScroll("#initial-selector")
    ...
    computed:{
        initialList:function(){
            ...
            for(key in this.data){
                initialList.push(key)
            }
            return initialList
        }
    },
    methods:{
        scorllToLetter:function(e){
            var $quickSearch=$(this.$el).find(".quick-search"),
                listTitle=document.querySelectorAll("[data-letter]"),
                touchX=e.touches[0].clientX,
                touchY=e.touches[0].clientY,
                listLength =myScroll.maxScrollY,
                searchHeight=$quickSearch.height(),
                searchTop=$quickSearch.offset().top,
                searchBottom=$quickSearch.offset().top+searchHeight,
                rate=parseInt((touchY-searchTop)/searchHeight*26)
            myScroll.scrollToElement(listTitle[rate])
        }
    }
})
myScroll.refresh()
exports=vList
},{"../data/data.json":65,"iscroll":1,"vue":62,"zepto-browserify":64}],68:[function(require,module,exports){
//var zepto = require("zepto-browserify")
//var IScroll = require('iscroll')
//var $ = zepto.$
//var myScroll = new IScroll(".initial-selector")
//$("#initial-selector .quick-search").on("touchmove", function (e) {
//    var $quickSearch=$(".initial-selector .quick-search"),
//        touchX=e.touches[0].clientX,
//        touchY=e.touches[0].clientY,
//        listLength =myScroll.maxScrollY,
//        searchHeight=$quickSearch.height(),
//        searchTop=$quickSearch.offset().top,
//        searchBottom=$quickSearch.offset().top+searchHeight,
//        rate=(touchY-searchTop)/searchHeight
//    myScroll.scrollTo(0,rate*listLength)
//    console.log(touchX,touchY, searchTop, searchBottom,rate)
//})
},{}]},{},[66])